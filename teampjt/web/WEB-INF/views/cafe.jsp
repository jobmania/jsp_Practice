 ...
 <input type="hidden" name="page" value="1"> <%-- 페이지 1 값 보내기 --%>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" href="/cafe?page=<%= currentPage-1 %>">previous</a></li>
            <% } %>
            ...
            <% for (int i = startPage; i <= endPage; i++) {
                ...
                if (i == currentPage) { %>
            <li class="page-item active"><a class="page-link" href="/cafe?page=<%= i %>"><%= i %></a></li>
            <% } else { %>
            <li class="page-item"><a class="page-link" href="/cafe?page=<%= i %>"><%= i %></a></li>
            <% } %>
            <% } %>


            <% if (currentPage != totalPages && totalPages!=0 ) { %>
            <li class="page-item"><a class="page-link" href="/cafe?page=<%= currentPage+1 %>">next</a></li>
            <% } %>
        </ul>
    </nav>
